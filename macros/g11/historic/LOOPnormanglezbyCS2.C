...
//-----------DEFINE CROSS SECTION AND BEAM ENERGY VECTOR-------------
...
realhist[i]=new TH1F(Form("hr%d",i),"",zbin,zlow,zhigh);
simhist[i]=new TH1F(Form("hs%d",i),"",zbin,zlow,zhigh);
 }
...
//for( Int_t i=0;i<11;i++){
//  simt->Draw("beam>>simbeam[i]",mycut&&rb&&beam[i]);

   
simt->Draw("beam>>hsb0",mycut&&beam0&&rb);
simt->Draw("beam>>hsb1",mycut&&beam1&&rb);
simt->Draw("beam>>hsb2",mycut&&beam2&&rb);
simt->Draw("beam>>hsb3",mycut&&beam3&&rb);
simt->Draw("beam>>hsb4",mycut&&beam4&&rb);
simt->Draw("beam>>hsb5",mycut&&beam5&&rb);
simt->Draw("beam>>hsb6",mycut&&beam6&&rb);
simt->Draw("beam>>hsb7",mycut&&beam7&&rb);
simt->Draw("beam>>hsb8",mycut&&beam8&&rb);
simt->Draw("beam>>hsb9",mycut&&beam9&&rb);
simt->Draw("beam>>hsb10",mycut&&beam10&&rb);

realt->Draw("beam>>hrb0",mycut&&beam0&&rb);
realt->Draw("beam>>hrb1",mycut&&beam1&&rb);
realt->Draw("beam>>hrb2",mycut&&beam2&&rb);
realt->Draw("beam>>hrb3",mycut&&beam3&&rb);
realt->Draw("beam>>hrb4",mycut&&beam4&&rb);
realt->Draw("beam>>hrb5",mycut&&beam5&&rb);
realt->Draw("beam>>hrb6",mycut&&beam6&&rb);
realt->Draw("beam>>hrb7",mycut&&beam7&&rb);
realt->Draw("beam>>hrb8",mycut&&beam8&&rb);
realt->Draw("beam>>hrb9",mycut&&beam9&&rb);
realt->Draw("beam>>hrb10",mycut&&beam10&&rb);
