...
//*
c1->cd(1); 
TH1F *h2=new TH1F("h2","mm(k+k+pi-)",100,1.0,1.3);
newt->Draw("sqrt(mm2kpkppim)>>h2",mynewB&&mycasB);
fitGAUS(h2,1,1.05,1.2,5,1,1,1.1162,0.01,3);
// */
...
//*
 c1->cd(2); 
TH1F *h2=new TH1F("h2","mm(k+k+)",100,1.2,1.5);
newt->Draw("sqrt(mm2kpkp)>>h2",mynewB&&mylambdaB);
