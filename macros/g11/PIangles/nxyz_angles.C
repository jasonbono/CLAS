...
void nxyz_angles(){
  ...
  TFile *f = TFile::Open("nxyzSIM.root","UPDATE");     	
...
TBranch *PIanglexBranch = newt->Branch("PIanglex", &PIanglex, "PIanglex/F");
TBranch *PIangleyBranch = newt->Branch("PIangley", &PIangley, "PIangley/F");
TBranch *LAMBanglexBranch = newt->Branch("LAMBanglex", &LAMBanglex, "LAMBanglex/F");
TBranch *LAMBangleyBranch = newt->Branch("LAMBangley", &LAMBangley, "LAMBangley/F");
