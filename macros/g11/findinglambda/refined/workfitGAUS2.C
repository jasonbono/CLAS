// nov 15 2011 made from workfitGAUS.C to also include the mass
...
//*
c1->cd(1); 
TH1F *h2=new TH1F("h2","",100,1.0,1.3);
new->Draw("sqrt(mm2kpkppim)>>h2",mynewB&&mycasB);
...
//*
 c1->cd(2); 
TH1F *h2=new TH1F("h2","",100,1.2,1.5);
