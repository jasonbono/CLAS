...
c1->Divide(2,0);
c1->cd(1); 
newt->Draw("cos(PIangle)>>h1",mycut&&oneB&&EBin1);
c1->cd(2);
newt->Draw("cos(PIangle)>>h2",mycut&&twoB&&EBin1);
 neg=h1->GetEntries();
 pos=h2->GetEntries();
 cout<<"for low beam energy:";
 cout<<" ";
 cout<<"neg=";
 cout<<neg;
 cout<<" ";
...
c2->Divide(2,0);
c2->cd(1); 
newt->Draw("cos(PIangle)>>h3",mycut&&oneB&&EBin2);
c2->cd(2);
newt->Draw("cos(PIangle)>>h4",mycut&&twoB&&EBin2);
 neg=h3->GetEntries();
 pos=h4->GetEntries();
 cout<<"for mid beam energy:";
 cout<<" "; 
 cout<<"neg=";
 cout<<neg;
 cout<<" ";
...
c3->Divide(2,0);
c3->cd(1); 
newt->Draw("cos(PIangle)>>h5",mycut&&oneB&&EBin3);
c3->cd(2);
newt->Draw("cos(PIangle)>>h6",mycut&&twoB&&EBin3);
 neg=h5->GetEntries();
 pos=h6->GetEntries();
 cout<<"for high beam energy:";
 cout<<" "; 
cout<<"neg=";
 cout<<neg;
 cout<<" ";
...
cout<< ep3 <<endl;
   ...
   can1 = new TCanvas("can1","how does polarisation change with beam energy?",200,10,700,500);
   ...
   gr->SetTitle("beam energy 1=low 2=Middle 3=high");
   gr->SetMarkerColor(4);
