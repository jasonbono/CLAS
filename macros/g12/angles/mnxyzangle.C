...
jan 15:  added the m angles and changed the name of the macro from nxyz to mnxyz
...
//===============================================================================================================
	...
	TCanvas *cM2=new TCanvas("cM2","",1200,800);
	...
	TH1F *hM=new TH1F("hM","",10,-1,1);
	TH1F *hMside=new TH1F("hMside","",10,-1,1);
	TH1F *hMsideNorm=new TH1F("hMsideNorm","",10,-1,1);
	TH1F *hMsub=new TH1F("hMsub","",10,-1,1);
	TH1F *hM2=new TH1F("hM2","",10,-1,1);
	TH1F *hMside2=new TH1F("hMside2","",10,-1,1);
	TH1F *hMsideNorm2=new TH1F("hMsideNorm2","",10,-1,1);
	TH1F *hMsub2=new TH1F("hMsub2","",10,-1,1);
    ...
    hM->GetXaxis()->SetTitle("from lam peak cos(#theta_{m}^{#pi^{-}})");
	hMsub->GetYaxis()->SetTitle("Events");
    hMsub->GetXaxis()->SetTitle("subtracted cos(#theta_{m}^{#pi^{-}})");
	hM2->GetYaxis()->SetTitle("Events");
    hM2->GetXaxis()->SetTitle("from cas peak cos(#theta_{m}^{#pi^{-}})");
	hMsub2->GetYaxis()->SetTitle("Events");
    hMsub2->GetXaxis()->SetTitle("subtracted2 cos(#theta_{m}^{#pi^{-}})");
	...
	newt->Draw("cos(PIanglem_cm)>>hM",newbasic&&casm&&lamp);
	newt->Draw("cos(PIanglem_cm)>>hMside",newbasic&&casm&&lamsb);
	...
	newt->Draw("cos(PIanglem_cm)>>hM2",newbasic&&lamm&&casp);
	newt->Draw("cos(PIanglem_cm)>>hMside2",newbasic&&lamm&&cassb);
	...
	hMsideNorm->Add(hMside,fac);
	hMsub->Add(hM,1);
	hMsub->Add(hMsideNorm,-1);
	...
	hMsideNorm2->Add(hMside2,fac2);
	hMsub2->Add(hM2,1);
	hMsub2->Add(hMsideNorm2,-1);
	...
	hM2->SetMinimum(0);
	hMside2->SetMinimum(0);
	hMsideNorm2->SetMinimum(0);
	hMsub2->SetMinimum(0);
	...
	hMsideNorm->SetFillColor(2);
	hMsideNorm->SetFillStyle(3004);
	...
	hMsideNorm2->SetFillColor(2);
	hMsideNorm2->SetFillStyle(3004);
	...
	cout << "now drawing m angle" << endl;
	cM->cd(1);
	hM->Draw();
	hMsideNorm->Draw("same");	
	cM->cd(2);
	hMsub->Draw();
...
cout << "now drawing m angle 2" << endl;	
	cM2->cd(1);
	hM2->Draw();
	hMsideNorm2->Draw("same");	
	cM2->cd(2);
	hMsub2->Draw();
	...
	clamfit->Print("~/clas/pics/12_jan16/g12talk/angles/lamdaFit.eps");
	ccasfit->Print("~/clas/pics/12_jan16/g12talk/angles/cascadeFit.eps");
	ccuts->Print("~/clas/pics/12_jan16/g12talk/angles/cuts.eps");
	
	
	cX->Print("~/clas/pics/12_jan16/g12talk/angles/XanglesLam.eps");
	cY->Print("~/clas/pics/12_jan16/g12talk/angles/YanglesLam.eps");
	cZ->Print("~/clas/pics/12_jan16/g12talk/angles/ZanglesLam.eps");
	cN->Print("~/clas/pics/12_jan16/g12talk/angles/NanglesLam.eps");
	cM->Print("~/clas/pics/12_jan16/g12talk/angles/ManglesLam.eps");
	
	cX2->Print("~/clas/pics/12_jan16/g12talk/angles/XanglesCas.eps");
	cY2->Print("~/clas/pics/12_jan16/g12talk/angles/YanglesCas.eps");
	cZ2->Print("~/clas/pics/12_jan16/g12talk/angles/ZanglesCas.eps");
	cN2->Print("~/clas/pics/12_jan16/g12talk/angles/NanglesCas.eps");
	cM2->Print("~/clas/pics/12_jan16/g12talk/angles/ManglesCas.eps");
