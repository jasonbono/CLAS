...
void Addxyz()
{
 ...
 //TTree *tOriginal = (TTree*)f->Get("v25k"); 
 
 //TFile *f = TFile::Open("~/clas/rootfiles/g11/xyzReal.root","UPDATE");  
 //TTree *tOriginal = (TTree*)f->Get("new");
 
 // TFile *f = TFile::Open("~/clas/rootfiles/g11/xyzSim.root","UPDATE");  
 // TTree *tOriginal = (TTree*)f->Get("g112kppim");

 // TFile *f = TFile::Open("~/clas/rootfiles/g12/v28k_tiny.root","UPDATE");  
 // TTree *tOriginal = (TTree*)f->Get("v28k");


 TFile *file = TFile::Open("/Users/Bono/clas/rootfiles/g12/2kppim/v09/test.root");
 TTree *tOriginal = (TTree*)file->Get("v09");
 ...
 TBranch *mr_COS_pi_xBranch = tOriginal->Branch("mr_COS_pi_x", &mr_COS_pi_x, "mr_COS_pi_x/F");
 TBranch *mr_COS_pi_yBranch = tOriginal->Branch("mr_COS_pi_y", &mr_COS_pi_y, "mr_COS_pi_y/F");
 TBranch *mr_COS_pi_zBranch = tOriginal->Branch("mr_COS_pi_z", &mr_COS_pi_z, "mr_COS_pi_z/F");

 TBranch *mr_COS_lam_xBranch = tOriginal->Branch("mr_COS_lam_x", &mr_COS_lam_x, "mr_COS_lam_x/F");
 TBranch *mr_COS_lam_yBranch = tOriginal->Branch("mr_COS_lam_y", &mr_COS_lam_y, "mr_COS_lam_y/F");
 TBranch *mr_COS_lam_zBranch = tOriginal->Branch("mr_COS_lam_z", &mr_COS_lam_z, "mr_COS_lam_z/F"); 
...
//==============================================================================FILL THE BRANCHES AND END=======================================================================
 ...
 tOriginal->Write("", TObject::kOverwrite);
 gROOT->ProcessLine(".q");
}
