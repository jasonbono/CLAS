...
feb 6 made this the macro to use for g11 or g12 data. its easeier this way
...
TFile *f = TFile::Open("~/clas/rootfiles/g12/v24k_tiny.root","UPDATE");  //for real g11 rootfile 
TTree *addedt = (TTree*)f->Get("v24k");  //for real g11 rootfile
