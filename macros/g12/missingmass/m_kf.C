...
void m_kf()
{
	...
	can[2]->cd(1);
	newt->Draw("mlampim>>histCas_2",conf);
	fitGAUS(histCas_2,1,1.25,1.4,1,0,0,1.32,0.045,3);
	can[2]->cd(2);
	newt->Draw("mcasmMpim>>histLam_2",conf);
	fitGAUS(histLam_2,1,1.05,1.2,1,0,0,1.116,0.045,3);	
