...
void debug(){
  ...
  //TFile *_file0 = TFile::Open("dbg.root");
TFile *_file0 = TFile::Open("std.root");
...
fpi->Divide(2,2);
fpi->cd(1); 
g112kppim->Draw("ppim",mycut);
fpi->cd(2); 
g112kppim->Draw("sin(TMath::ACos(pilabtheta))*cos(pilabphi*TMath::Pi())",mycut);
fpi->cd(3); 
g112kppim->Draw("sin(TMath::ACos(pilabtheta))*sin(pilabphi*TMath::Pi())",mycut);
fpi->cd(4); 
g112kppim->Draw("pilabtheta",mycut); 
...
fpi2->Divide(2,0);
fpi2->cd(1); 
g112kppim->Draw("TMath::ACos(pilabtheta)",mycut);
fpi2->cd(2);
g112kppim->Draw("pilabphi*TMath::Pi()",mycut);

TCanvas *fpi3=new TCanvas("fpi3","",1200,820);
fpi3->Divide(2,0);
fpi3->cd(1); 
g112kppim->Draw("sin(pilabphi*TMath::Pi())",mycut);
fpi3->cd(2);
g112kppim->Draw("cos(pilabphi*TMath::Pi())",mycut);
...
c0->Divide(2,2);
c0->cd(1); 
g112kppim->Draw("Epil>>h1",mycut);
c0->cd(2); 
g112kppim->Draw("Epil>>h2",mycut);
c0->cd(3); 
g112kppim->Draw("Erestcas>>h3",mycut);

//*/
TCanvas *f1=new TCanvas("f1","",1200,820);
f1->Divide(2,0);
f1->cd(1);
 g112kppim->Draw("cos(PIangleLAB)+cos(LAMBangleLAB)",mycut);
f1->cd(2);
 g112kppim->Draw("cos(PIangle)+cos(LAMBangle)",mycut);

 //*
TCanvas *c1=new TCanvas("c1","",1200,820);
c1->Divide(2,2);
c1->cd(1);
g112kppim->Draw("PIangleLAB");
c1->cd(2);
g112kppim->Draw("PIangle");
c1->cd(3);
g112kppim->Draw("LAMBangleLAB");
c1->cd(4); 
g112kppim->Draw("LAMBangle");
 

TCanvas *c1b=new TCanvas("c1b","",1200,820);
c1b->Divide(2,2);
c1b->cd(1);
 g112kppim->Draw("cos(PIangleLAB)",mycut);
c1b->cd(2);
g112kppim->Draw("cos(PIangle)",mycut);
c1b->cd(3);
g112kppim->Draw("cos(LAMBangleLAB)",mycut);
c1b->cd(4); 
g112kppim->Draw("cos(LAMBangle)",mycut);
//*/
//*
...
TCanvas *c2=new TCanvas("c2","",1200,820);
 c2->Divide(2,3);
 c2->cd(1);
g112kppim->Draw("LABcasDOTnormLAB");
 c2->cd(2);
g112kppim->Draw("LABcasDOTnormCM");
 c2->cd(3);
g112kppim->Draw("LABcasDOTnormLAB",lab);
 c2->cd(4);
 g112kppim->Draw("LABcasDOTnormCM",cm);
 c2->cd(5);
 g112kppim->Draw("LABcasDOTnormLAB",!cm);
 c2->cd(6);
 g112kppim->Draw("LABcasDOTnormCM",!lab);


TCanvas *c3=new TCanvas("c3","",1200,820);
c3->Divide(2,3);
c3->cd(1);
g112kppim->Draw("Xlabtheta");
c3->cd(2);
g112kppim->Draw("Xcmtheta");
c3->cd(3);
g112kppim->Draw("Xlabtheta",lab&&cm);
c3->cd(4);
g112kppim->Draw("Xcmtheta",lab&&cm);
c3->cd(5);
g112kppim->Draw("Xlabtheta",!lab&&!cm);
c3->cd(6);
g112kppim->Draw("Xcmtheta",!lab&&!cm);
