...
void simresultsDBG(){
  ...
  //TFile *f = new TFile("simulation.root","UPDATE");
TFile *f = new TFile("dbg.root","UPDATE");
//TFile *f = new TFile("std.root","UPDATE");
TTree *newt = (TTree*)f->Get("g112kppim");
