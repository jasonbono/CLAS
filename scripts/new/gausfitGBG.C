...
Notes: Made this from myfitGAUS5.C. 

Usage: call the function gausfitGBG(histo, Int_t tryno, low, high, term0, term1, term2, start-mean, start-width,factor, 
Double_t & myBackground, Double_t & myYield, Double_t & myRms, Double_t & myMean, Double_t & myYieldErr)
...
// CALL THIS
Double_t  gausfitGBG(TH1F *histo, Int_t tryno, Double_t low, Double_t high, Double_t term0, 
