...
Double_t  fitGAUS4(TH1F *histo, Int_t tryno, Double_t low, Double_t high, Double_t term0, 
  Double_t term1,Double_t term2, Double_t mean, Double_t width, Double_t factor, 
  Double_t & myBackground, Double_t & myYield, Double_t & myRms, Double_t & myMean)
{
  //TText *sum[100];
