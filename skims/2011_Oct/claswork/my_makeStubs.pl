...
#Oct edited to put output on tape
...
$in_dir = "/w/mss/clas/g12/production/pass1/bos/1-1ckaon1ctrk";
$out_dir = "/w/mss/clas/g12/production/pass1/user_skims/jbono/kpkppim";
#$out_dir = "/w/hallb/clasg12/jbono/skim/Oct6_11/bos";
...
chomp;
    ...
    print OUT "COMMAND: /w/hallb/clasg12/jbono/skim/Oct6_11/kpkppim $_ -ofile1\.bos\n";
    print OUT "INPUT_FILES: $in_dir/$_\n";
    print OUT "OUTPUT_DATA: file1\.bos\nOUTPUT_TEMPLATE: $out_dir/$_\.bos\n";  
    print OUT "SINGLE_JOB: true\n";
    print OUT "DISK_SPACE: 5 GB\nTIME: 60\n";
    print OUT "MEMORY: 500 MB\n";
    close(OUT);
    }
