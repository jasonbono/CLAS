...
$outdir1 = "/mss/clas/g12/production/pass1/user_skims/jbono/baduis/pkppim";
$workdir = "/w/hallb/clasg12/jbono/skim/badui/pkppim";
...
while($i < $arrayLength){
  ...
  $filename = $array[$i];
    ...
    print OUT "PROJECT: g12\nTRACK: analysis\nJOBNAME: badui-pkppim-bos-view-skim-$filename\nOS: centos62\n";
    print OUT "COMMAND: source environment.csh ; perl anapkppim_perl";
    print OUT "\n";
    print OUT "INPUT_FILES:\n";
    print OUT "/group/clas/builds/environment.csh\n";
    print OUT "$workdir\/farm/ana_pkppim\n";
    print OUT "$workdir\/farm/anapkppim_perl\n";
