...
void Polarization()
{
	...
	if{
		const Double_t W[NEBins] =	{0.461902, 1.76516, 1.21934};
		const Double_t Werr[NEBins] =	{0.059323, 0.225922, 0.159794};	
	}
	...
	//conf cut
 	...
 	TFile* fGen = new TFile("v07.gamp.root");       // GEN histograms 
