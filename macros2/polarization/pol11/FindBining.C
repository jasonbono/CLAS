...
void FindBining()
{
	...
	for (int j = 0; j < NEBins; j++)
	{
		cout << "Totalx_E[" << j << "] = "<< Totalx_E[j] <<endl;
		cout << "Totaly_E[" << j << "] = "<< Totaly_E[j] <<endl;
		cout << "Totalz_E[" << j << "] = "<< Totalz_E[j] <<endl;
	}
	cout << endl;
		
	for (int j = 0; j < NEBins; j++)
	{
		cout << "Totalx_Xi[" << j << "] = "<< Totalx_Xi[j] <<endl;
		cout << "Totaly_Xi[" << j << "] = "<< Totaly_Xi[j] <<endl;
		cout << "Totalz_Xi[" << j << "] = "<< Totalz_Xi[j] <<endl;	
	}
/*	
	cout << "totals per bin" <<endl;
