...
void Stage2()
{
	...
	for (int i = 0; i < NXiBins; i++)
	{
		...
		for (int j = 0; j < NPiBins; j++)
		{
			...
			//----------------------------------------------------------Data-----------------------------------------------------------------------
			t4=0; t3=0; t2=2; t1=1; t0=1; fitLow = 1.25; fitHigh = 1.41; fitWidth = 0.0055; fitWidthFloat = 0.0005;
			//*//<........................................................X.....................................................
			//get the yields
			cDataXix->cd(4*i + j + 1);
			...
			//fix the yields in the medium pi angle
			if(YieldMCXix[i][j] < 10){YieldMCXiy[i][j] = 10; YieldMCXiyErr[i][j] = 10;}
			//fill the yields to the histograms
