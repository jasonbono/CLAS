...
void GetW(){
	...
	//-------------------------------further setup----------------------------------------
 	TFile *fData = TFile::Open("/Users/Bono/clas/rootfiles/g12/newbasic/v37k_full_newbasic.root");
	TFile *fMC = TFile::Open("/Users/Bono/clas/macros2/polarization/MC_v07_v37k.root");
