...
Usage:    > root -l -b 
		  ...
		  which will output somefile_VeryBasic.root
...
void VeryBasicTreeFile(TString passed)
{
	...
	for (Long64_t i=0; i<nentries; i++)
	{
        ...
        bool cut_VeryBasic = cut_n&&cut_np&&cut_vcut&&cut_beam;
	...
	nf = nentries;
	nf3 = nentries_Basic;
	cout << 100.0*(( nf - nf3 )/(nf))  << " % of entries were taken out of the original tree DOG " << endl;
