...
## rm work.part 
#rm work.gsim work.gsim.gpp gpp.hbook
...
mv gpp2kppim.root ANA.gsim.gpp.root
GGG work.gamp
rm work.gamp work.part work.gsim work.gsim.gpp work.gsim.gpp.a1c


# 
# #polarize the files in X and output only the root files
# PLR work.gamp x #this will output two more files: PosPolwork.gamp & NegPolwork.gamp
# mygamp2part -r10 -oPosPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 PosPolwork.gamp
# mygamp2part -r10 -oNegPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 NegPolwork.gamp
# gsim_bat -ffread ffread.g12 -kine 1 -mcin PosPolwork.part -bosout PosPolwork.gsim -trig 2000000
# gsim_bat -ffread ffread.g12 -kine 1 -mcin NegPolwork.part -bosout NegPolwork.gsim -trig 2000000
...
# root -q -l -b gpp2kppim.C
# rm gpp2kppim.view gpp2kppim.lab gpp2kppim.C
# mv gpp2kppim.root PosPolXANA.gsim.gpp.root
# 
# ANA -agpp2kppim.view -X0 -R10  -C1 NegPolwork.gsim.gpp.a1c
# ANA -L > gpp2kppim.lab
# makentfile gpp2kppim < gpp2kppim.lab > gpp2kppim.C
# root -q -l -b gpp2kppim.C
# rm gpp2kppim.view gpp2kppim.lab gpp2kppim.C
# mv gpp2kppim.root NegPolXANA.gsim.gpp.root
# 
# rm PosPolwork.gamp PosPolwork.part PosPolwork.gsim PosPolwork.gsim.gpp PosPolwork.gsim.gpp.a1c
# 
# 
# 
# 
# 
# 
# #polarize the files in Z and output only the root files
# PLR work.gamp z #this will output two more files: PosPolwork.gamp & NegPolwork.gamp
# mygamp2part -r10 -oPosPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 PosPolwork.gamp
# mygamp2part -r10 -oNegPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 NegPolwork.gamp
# gsim_bat -ffread ffread.g12 -kine 1 -mcin PosPolwork.part -bosout PosPolwork.gsim -trig 2000000
# gsim_bat -ffread ffread.g12 -kine 1 -mcin NegPolwork.part -bosout NegPolwork.gsim -trig 2000000
...
# root -q -l -b gpp2kppim.C
# rm gpp2kppim.view gpp2kppim.lab gpp2kppim.C
# mv gpp2kppim.root PosPolZANA.gsim.gpp.root
# 
# ANA -agpp2kppim.view -X0 -R10  -C1 NegPolwork.gsim.gpp.a1c
# ANA -L > gpp2kppim.lab
# makentfile gpp2kppim < gpp2kppim.lab > gpp2kppim.C
# root -q -l -b gpp2kppim.C
# rm gpp2kppim.view gpp2kppim.lab gpp2kppim.C
# mv gpp2kppim.root NegPolZANA.gsim.gpp.root
# 
# rm PosPolwork.gamp PosPolwork.part PosPolwork.gsim PosPolwork.gsim.gpp PosPolwork.gsim.gpp.a1c
# 
# 
...
# 
# 
# #polarize the files in X and Z and output only the root files
# PLR work.gamp x z #this will output two more files: PosPolwork.gamp & NegPolwork.gamp
# mygamp2part -r10 -oPosPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 PosPolwork.gamp
# mygamp2part -r10 -oNegPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 NegPolwork.gamp
# gsim_bat -ffread ffread.g12 -kine 1 -mcin PosPolwork.part -bosout PosPolwork.gsim -trig 2000000
# gsim_bat -ffread ffread.g12 -kine 1 -mcin NegPolwork.part -bosout NegPolwork.gsim -trig 2000000
...
# root -q -l -b gpp2kppim.C
# rm gpp2kppim.view gpp2kppim.lab gpp2kppim.C
# mv gpp2kppim.root PosPolXZANA.gsim.gpp.root
# 
# ANA -agpp2kppim.view -X0 -R10  -C1 NegPolwork.gsim.gpp.a1c
# ANA -L > gpp2kppim.lab
# makentfile gpp2kppim < gpp2kppim.lab > gpp2kppim.C
# root -q -l -b gpp2kppim.C
# rm gpp2kppim.view gpp2kppim.lab gpp2kppim.C
# mv gpp2kppim.root NegPolXZANA.gsim.gpp.root
# 
# rm PosPolwork.gamp PosPolwork.part PosPolwork.gsim PosPolwork.gsim.gpp PosPolwork.gsim.gpp.a1c
# 
# 
...
#polarize the files in Y and output only the root files
PLR work.gamp y #this will output two more files: PosPolwork.gamp & NegPolwork.gamp
mygamp2part -r10 -oPosPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 PosPolwork.gamp
mygamp2part -r10 -oNegPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 NegPolwork.gamp
gsim_bat -ffread ffread.g12 -kine 1 -mcin PosPolwork.part -bosout PosPolwork.gsim -trig 2000000
gsim_bat -ffread ffread.g12 -kine 1 -mcin NegPolwork.part -bosout NegPolwork.gsim -trig 2000000
...
root -q -l -b gpp2kppim.C
rm gpp2kppim.view gpp2kppim.lab gpp2kppim.C
mv gpp2kppim.root PosPolYANA.gsim.gpp.root
GGG PosPolwork.gamp
mv PosPolwork.gamp.root PosPolYwork.gamp.root
...
root -q -l -b gpp2kppim.C
rm gpp2kppim.view gpp2kppim.lab gpp2kppim.C
mv gpp2kppim.root NegPolYANA.gsim.gpp.root
GGG NegPolwork.gamp
mv NegPolwork.gamp.root NegPolYwork.gamp.root

rm PosPolwork.gamp PosPolwork.part PosPolwork.gsim PosPolwork.gsim.gpp PosPolwork.gsim.gpp.a1c
rm NegPolwork.gamp NegPolwork.part NegPolwork.gsim NegPolwork.gsim.gpp NegPolwork.gsim.gpp.a1c
