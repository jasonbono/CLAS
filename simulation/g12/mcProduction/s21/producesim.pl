...
while( (${U} < ${upperBeam}) && (${proceed}) )
{
	...
	if($emean >= 2.8 && $emean <= 3.1375){$tslope=3.32908;}
	elsif($emean >= 3.1375 && $emean <= 3.475){$tslope=2.60323;}
	elsif($emean >= 3.475 && $emean <= 3.8125){$tslope=2.44334;}
	elsif($emean >= 3.8125 && $emean <= 4.15){$tslope=2.48642;}
	elsif($emean >= 4.15 && $emean <= 4.4875){$tslope=2.51055;}
	elsif($emean >= 4.4875 && $emean <= 4.825){$tslope=2.7287;}
	elsif($emean >= 4.825 && $emean <= 5.1625){$tslope=2.68649;}
	elsif($emean >= 5.1625 && $emean <= 5.5){$tslope=2.7187;}		
