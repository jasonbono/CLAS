...
while( (${U} < ${upperBeam}) && (${proceed}) )
{
	...
	if($emean >= 2.8 && $emean <= 3.1375){$tslope=1.79998;}
	elsif($emean >= 3.1375 && $emean <= 3.475){$tslope=1.48975;}
	elsif($emean >= 3.475 && $emean <= 3.8125){$tslope=1.3655;}
	elsif($emean >= 3.8125 && $emean <= 4.15){$tslope=1.24452;}
	elsif($emean >= 4.15 && $emean <= 4.4875){$tslope=1.22;}
	elsif($emean >= 4.4875 && $emean <= 4.825){$tslope=1.44453;}
	elsif($emean >= 4.825 && $emean <= 5.1625){$tslope=1.33879;}
	elsif($emean >= 5.1625 && $emean <= 5.5){$tslope=1.30744;}		
