...
while( (${U} < ${upperBeam}) && (${proceed}) )
{
	...
	if($emean >= 2.8 && $emean <= 3.1375){$tslope=1.97314;}
	elsif($emean >= 3.1375 && $emean <= 3.475){$tslope=1.67376;}
	elsif($emean >= 3.475 && $emean <= 3.8125){$tslope=1.67475;}
	elsif($emean >= 3.8125 && $emean <= 4.15){$tslope=1.57886;}
	elsif($emean >= 4.15 && $emean <= 4.4875){$tslope=1.54484;}
	elsif($emean >= 4.4875 && $emean <= 4.825){$tslope=1.82993;}
	elsif($emean >= 4.825 && $emean <= 5.1625){$tslope=1.6633;}
	elsif($emean >= 5.1625 && $emean <= 5.5){$tslope=1.59805;}		
