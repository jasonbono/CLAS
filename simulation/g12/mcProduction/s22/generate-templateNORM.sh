...
#run all three files through gamp2part or gamp2txt|txt2part
...
gamp2part -r10 -oPosPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 PosPolwork.gamp
gamp2part -r10 -oNegPolwork.part -T -S-0.321,0.378,-0.254,0.407 -z-110,-70 NegPolwork.gamp
...
#run all three gsim files through gpp
...
gpp -Y -s -a2.73 -b1.7 -c1.93 -f1 -R10 -P0x7f -oPosPolwork.gsim.gpp PosPolwork.gsim
gpp -Y -s -a2.73 -b1.7 -c1.93 -f1 -R10 -P0x7f -oNegPolwork.gsim.gpp NegPolwork.gsim

#run all three gsim files through a1c
