...
push(@Mass,1.925);
push(@Width,0.053*2.3); #2.3 is to give fwhm from the fitted gaus widths
push(@Mass,2.001);
...
while( (${U} < ${upperBeam}) && (${proceed}) )
{
	...
	if($emean >= 2.8 && $emean <= 3.1375){$tslope=1.55003;}
	elsif($emean >= 3.1375 && $emean <= 3.475){$tslope=1.22935;}
	elsif($emean >= 3.475 && $emean <= 3.8125){$tslope=1.10612;}
	elsif($emean >= 3.8125 && $emean <= 4.15){$tslope=1.04835;}
	elsif($emean >= 4.15 && $emean <= 4.4875){$tslope=1.13759;}
	elsif($emean >= 4.4875 && $emean <= 4.825){$tslope=1.40037;}
	elsif($emean >= 4.825 && $emean <= 5.1625){$tslope=1.41097;}
	elsif($emean >= 5.1625 && $emean <= 5.5){$tslope=1.39882;}		
