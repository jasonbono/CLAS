...
while( (${U} < ${upperBeam}) && (${proceed}) )
{
	...
	if($U >= 2.7 && $emean <= 3.7){$tslope=2.7;} #this first step is a double step
	elsif($emean >= 3.7 && $emean <= 4.15){$tslope=2.44133;}
	elsif($emean >= 4.15 && $emean <= 4.6){$tslope=2.95811;}
	elsif($emean >= 4.6 && $emean <= 5.05){$tslope=2.9349;}
	elsif($emean >= 5.05 && $emean <= 5.5){$tslope=2.81485;}	
