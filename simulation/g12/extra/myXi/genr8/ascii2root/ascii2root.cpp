...
change the ascii file name and the root file name

NOTE: THIS CODE WAS USED TO READ THE OUTPUT FROM THE ORIGINAL GENR8 INPUT FILE THAT I GOT WORKING WHICH DID NOT HAVE
THE DECAY OF THE LAMBDA.  FOR LOOKING AT THE NEWER ASCII OR GAMP FILES USE ascii2root_try4.cpp & gamp2root_try4.cpp
try4 indicates the directory on the claswork directory that the ascii and gamp files came from
...
{	
	...
	//local files
	TFile *newf = new TFile("myXi_10k.root","RECREATE"); 
