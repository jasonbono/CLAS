...
#perl producesim.pl -m1.96 -W0.22 -B4.00 -b3.90 -s0.1  -M1000 -vv01 -w/Users/Bono/clas/simulation/g12/full/jbono/sim_v05  -Igenr8input-template

#this is for testing on the farm
perl producesim.pl -m1.96 -W0.22 -B4.00 -b3.90 -s0.1  -M1000 -vv01 -w/u/home/jbono/SendGet/sim_v05  -Igenr8input-template

#or
#perl producesim.pl -m1.96 -W0.22 -B4.00 -b3.90 -s0.1  -M1000 -vv01 -w/u/home/jbono/simulation/sim_v05 -Igenr8input-template
