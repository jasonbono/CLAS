...
#choose the analyzer
thisana=v10 #the analyzer that will be run
thatana=v09 #the analyzer used to produce the bosfiles (only relavant for inputdir=$work option)
ana=/u/home/jbono/analyser/g12/LINKS/2kppim-${thisana}
tree=${thisana}

#choose the input 
workmany=/w/hallb/clasg12/jbono/analyzed-data/2kppim/${thatana}
worksingle=/w/hallb/clasg12/jbono/analyzed-data/2kppim/${thatana}/concated
tape=/cache/mss/clas/g12/production/pass1/user_skims/jbono/2kppim
indir=$workmany
#indir=tape
#indir=worksingle

#choose the output
out_prefix=2kppim-${thisana}
outpath=/w/hallb/clasg12/jbono/analyzed-data/2kppim/${thisana}
