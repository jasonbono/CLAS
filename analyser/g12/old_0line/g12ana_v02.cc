// V2 partialy changed the energy correction and momentum correction.
...
void PrintUsage(char *processName)
{
  ...
  //JB\\  cerr << "\t-C#\tperform eloss and momentum correction(C=1, perform correction; C=0, no correction\n";
//JB\\  cerr << "\t-F#\tIFLAG valued for eloss package(default 1)\n";
//JB\\  cerr << "\t\tIFLAG=0 - empty target. For IFLAG=0 no energy losses in target.\n";
//JB\\ cerr << "\t\tIFLAG=1 - LH2 target\n";
//JB\\ cerr << "\t\tIFLAG=2 - LD2 target\n";
//JB\\ cerr << "\t\tIFLAG=3 - L3He target\n";
  cerr << "\t-e\tInclude eloss package.\n"; //JB\\ 
  cerr << "\t-m\tcorrect momentum.\n";
