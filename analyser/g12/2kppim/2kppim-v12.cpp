...
//--------------------------------------------------beam energy corections,eloss,kaon switching --------------------------------------------------
 ...
 if ( (mmkpkp > CASCADE_MASS - 0.05) && (mmkpkp < CASCADE_MASS + 0.05) ) agood=1;
 //loose missing mass cuts on lambda (b)
 int bgood=0;
 float mmkpkppim = ~(beam + target - kp1 - kp2 - pim);
 if ( (mmkpkppim > LAMBDA_MASS - 0.05) && (mmkpkppim < LAMBDA_MASS + 0.05) ) bgood=1;
 ...
 if ( (mlampim > CASCADE_MASS - 0.018) && (mlampim < CASCADE_MASS + 0.018) ) cgood=1;
 ...
 if ( (mcasmMpim > LAMBDA_MASS - 0.018) && (mcasmMpim < LAMBDA_MASS + 0.018) ) dgood=1;
