...
*/
  ...
  //now boost to the Xi_CM rest-frame
  ...
  threeVec T_PIM_unit, T_KPKP_unit, T_BEAM_unit, T_LAM_unit, T_Xi_CM_unit;
  T_BEAM_unit.set(BEAM.x()/BEAM.r(), BEAM.y()/BEAM.r(), BEAM.z()/BEAM.r());  
  T_KPKP_unit.set(KPKP.x()/KPKP.r(), KPKP.y()/KPKP.r(), KPKP.z()/KPKP.r());
  T_Xi_CM_unit.set(Xi_CM.x()/Xi_CM.r(), Xi_CM.y()/Xi_CM.r(), Xi_CM.z()/Xi_CM.r() );
