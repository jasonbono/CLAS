/*
Feb 19 2014: adapted from 2kppim-v06.cpp
...
//--------------------------------------------------beam energy corections,eloss,kaon switching --------------------------------------------------
 ...
 if ( (mmkpkp > CASCADE_MASS - 0.12) && (mmkpkp < CASCADE_MASS + 0.12) ) agood=1;
 //loose missing mass cuts on lambda (b)
 int bgood=0;
 float mmkpkppim = ~(beam + target - kp1 - kp2 - pim);
 if ( (mmkpkppim > LAMBDA_MASS - 0.12) && (mmkpkp < LAMBDA_MASS + 0.12) ) bgood=1;
 ...
 if ( (mlampim > CASCADE_MASS - 0.03) && (mlampim < CASCADE_MASS + 0.03) ) cgood=1;
 ...
 if ( (mcasmMpim > LAMBDA_MASS - 0.03) && (mcasmMpim < LAMBDA_MASS + 0.03) ) dgood=1;
