...
//--------------------------------------------------beam energy corections,eloss,kaon switching --------------------------------------------------
 ...
 if ( (mmkpkp > CASCADE_MASS - 0.18) && (mmkpkp < CASCADE_MASS + 0.18) ) agood=1;
 //loose missing mass cuts on lambda (b)
 int bgood=0;
 float mmkpkppim = ~(beam + target - kp1 - kp2 - pim);
 if ( (mmkpkppim > LAMBDA_MASS - 0.18) && (mmkpkppim < LAMBDA_MASS + 0.18) ) bgood=1;
 ...
 if ( (mlampim > CASCADE_MASS - 0.09) && (mlampim < CASCADE_MASS + 0.09) ) cgood=1;
 ...
 if ( (mcasmMpim > LAMBDA_MASS - 0.09) && (mcasmMpim < LAMBDA_MASS + 0.09) ) dgood=1;
