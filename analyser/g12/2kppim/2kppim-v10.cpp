...
//--------------------------------------------------beam energy corections,eloss,kaon switching --------------------------------------------------
 ...
 if ( (mmkpkppim > LAMBDA_MASS - 0.12) && (mmkpkppim < LAMBDA_MASS + 0.12) ) bgood=1;
 ...
 if ( (mlampim > CASCADE_MASS - 0.04) && (mlampim < CASCADE_MASS + 0.04) ) cgood=1;
 ...
 if ( (mcasmMpim > LAMBDA_MASS - 0.04) && (mcasmMpim < LAMBDA_MASS + 0.04) ) dgood=1;
