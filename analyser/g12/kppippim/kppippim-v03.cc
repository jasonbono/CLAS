...
//--------------------------------------------------beam energy corections,eloss --------------------------------------------------
 ...
 //-------------setup the pipi and K0------------------------------------------------------------------------------
 fourVec pipi, k0;
 pipi = pip + pim;
 double Ek0 = sqrt(K0_MASS*K0_MASS + pipi.r()*pipi.r());
 k0.set(Ek0, threeVec(pipi.x(), pipi.y(), pipi.z()));
 
 //again for no pcor
 fourVec pipi_no_pcor, k0_no_pcor; 
 ...
 //again for no eloss
 fourVec pipi_no_eloss, k0_no_eloss; 
 pipi_no_eloss = pip_no_eloss + pim_no_eloss;
 double Ek0_no_eloss = sqrt(K0_MASS*K0_MASS + pipi_no_eloss.r()*pipi_no_eloss.r());
 k0_no_eloss.set(Ek0_no_eloss, threeVec(k0_no_eloss.x(), k0_no_eloss.y(), k0_no_eloss.z()));

 //again for no corrections
 fourVec pipi_no_corrections, k0_no_corrections; 
