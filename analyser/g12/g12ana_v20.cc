...
//JB\\ cout << ++nlab << "\tmissing mass square of (kp+kp+pim)using ps beam{psmm2kpkppim}"<<endl;
 ...
 //X rest frame angles
  ...
  cout << ++nlab << "\t(pi) pi norm angle2{PIangle_ANA2}"<<endl; //jb v18
  cout << ++nlab << "\t(pi) pi norm angle3{PIangle_ANA3}"<<endl; //jb v20
  ...
  //jb v20
  cout << ++nlab << "\t(tests) {XrestE}}"<<endl;
  cout << ++nlab << "\t(tests) {XrestM}}"<<endl;
  cout << ++nlab << "\t(tests) {XrestX}}"<<endl;
  cout << ++nlab << "\t(tests) {XrestY}}"<<endl;
  cout << ++nlab << "\t(tests) {XrestZ}}"<<endl;
...
// theese below are the cosine of the angles of intrest.
  ...
  //jb v20 testing to make sure that Xi is accualy at rest from the boose L9
  X_1 *= L9;
  output << X_1.t() << " ";
  output << ~X_1 << " ";
  output << X_1.x() << " ";
