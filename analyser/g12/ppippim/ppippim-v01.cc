...
// . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
 ...
 float mm2ppippim = mmppippim*mmppippim;
 ...
 int pp=0;
 if( (mpx > -0.4) && (mpx < 0.4) && (mpy > -0.4) && (mpy < 0.4) && (mpz > -0.4) && (mpz < 0.4)  ) pp=1;
 
 int mm=0;
 if(mm2ppippim < 0.1 ) mm=1;
 ...
 if(!(st&&pp&&mm))
 {
  //cout << "event not pass total filter!!!" <<endl;
 }
