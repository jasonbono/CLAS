/*
November 14 kpkp-v03: added momentum corrections similar to that in 2kppim-v05
...
//---photon stuff----
 ...
 //---particle stuff----
 fourVec kp1,kp2, kp0; //kp0 needed for fast kaon switching
 fourVec kp1_no_eloss, kp2_no_eloss, kp0_no_eloss;
 fourVec kp1_no_pcor, kp2_no_pcor, kp0_no_pcor; 
 fourVec kp1_no_corrections, kp2_no_corrections, kp0_no_corrections;
 ...
 //setup the eloss and ecor corrected four vectors
 ...
 if(st&&bb)  //jb v35k putting the filter back
 {
  ...
  //start outputing the rest of the quantities	
  output << runno<< " " <<evtno<< " ";
