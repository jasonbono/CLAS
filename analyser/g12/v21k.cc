...
//jb v15_kinfit
cout << ++nlab << "\t(first try with kinfit){kf_prob}"<<endl;
cout << ++nlab << "\t(first try with kinfit){kf_chi2}"<<endl;
cout << ++nlab << "\t(first try with kinfit){kf_pull_beam}"<<endl;
