...
*/
Float_t *PIangle=new Float_t();
Float_t *PIangleLAB=new Float_t();
Float_t *LAMBangle=new Float_t();
Float_t *LAMBangleLAB=new Float_t();
Float_t *LABcasDOTnormLAB=new Float_t();
Float_t *LABcasDOTnormCM=new Float_t();
Float_t *Epil=new Float_t();
Float_t *Erestcas=new Float_t();
Float_t *Eghost=new Float_t();
Float_t *ZprCM=new Float_t();
Float_t *ZbCM=new Float_t();
Float_t *ZpiLAB=new Float_t();
Float_t *normdiff=new Float_t();
Float_t *EbCM=new Float_t();
Float_t *EprCM=new Float_t();
