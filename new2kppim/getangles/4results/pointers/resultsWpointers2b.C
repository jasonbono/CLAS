...
void resultsWpointers2b(){
       	
TFile *f = new TFile("resultsWpointers2b.root","UPDATE");
...
//KAON 3&4-vec
 Xk1[0]=pkp1*sin(TMath::ACos(kp1labtheta))*kp1labphi;
 Yk1[0]=pkp1*sin(TMath::ACos(kp1labtheta))*sin(TMath::ACos(kp1labphi));
Zk1[0]=pkp1*kp1labtheta;

Tk1->SetXYZ(Xk1[0],Yk1[0],Zk1[0]);
 Fk1->SetXYZM(Tk1(0),Tk1(1),Tk1(2),Mk);

 Xk2[0]=pkp2*sin(TMath::ACos(kp2labtheta))*kp2labphi;
 Yk2[0]=pkp2*sin(TMath::ACos(kp2labtheta))*sin(TMath::ACos(kp2labphi));
Zk2[0]=pkp2*kp2labtheta;
...
//PION 3&4-vec
 Xpi[0]=ppim*sin(TMath::ACos(pilabtheta))*pilabphi;
 Ypi[0]=ppim*sin(TMath::ACos(pilabtheta))*sin(TMath::ACos(pilabphi));
Zpi[0]=ppim*pilabtheta;
