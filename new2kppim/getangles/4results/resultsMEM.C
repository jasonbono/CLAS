...
*/
 ...
 TH1F *PIangle=new TH1F("PIangle","",100,0,3.14);
 TH1F *PIangleLAB=new TH1F("PIangleLAB","",100,0,3.14);
 TH1F *LAMBangle=new TH1F("LAMBangle","",100,0,3.14);
 TH1F *LAMBangleLAB=new TH1F("LAMBangleLAB","",100,0,3.14);
 TH1F *LABcasDOTnormLAB;=new TH1F("LABcasDOTnormLAB;","",100,-2,2);
 TH1F *LABcasDOTnormCM;=new TH1F("LABcasDOTnormCM;","",100,-2,2);
 TH1F *Epil=new TH1F("Epil","",100,0,10);
 TH1F *Erestcas=new TH1F("Erestcas","",100,0,10);
 TH1F *Eghost=new TH1F("Eghost","",100,0,10);
 TH1F *ZprCM=new TH1F("ZprCM","",100,-10,10);
 TH1F *ZbCM=new TH1F("ZbCM","",100,-10,10);
 TH1F *ZpiLAB=new TH1F("ZpiLAB","",100,-10,10);
 TH1F *normdiff=new TH1F("normdiff","",100,-2,2);
 TH1F *EbCM=new TH1F("EbCM","",100,0,10);
 TH1F *EprCM=new TH1F("EprCM","",100,0,10);
